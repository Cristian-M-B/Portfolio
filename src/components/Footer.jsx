...
export default function Footer() {
    return (
        <div className='footer'>
            ...
            <a href='mailto:crisbaronetto@hotmail.com'><AiOutlineMail size={25} /></a>
            <a href='https://drive.google.com/file/d/1RxU-PS31Dnl6xrYCbIyAXI9s51hlbREu/view' target='_blank' rel='noreferrer'><AiOutlineFilePdf size={25} /></a>
        </div>
    )
}
